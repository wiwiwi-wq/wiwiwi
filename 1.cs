...
/////
            //Console.WriteLine("Введите значение перемнной - p");
            //double p = Convert.ToDouble(Console.ReadLine());

            //Console.WriteLine("Введите значение перемнной - y");
            //double y = Convert.ToDouble(Console.ReadLine());

            //Console.WriteLine("Введите значение перемнной - e");
            //double e = Convert.ToDouble(Console.ReadLine());

            //Console.WriteLine($"K = {Math.Log(Math.Pow(p, 2) + Math.Pow(y, 3)) + Math.Pow(e, p)}");

//////
            //Console.WriteLine("Введите значение перемнной - n");
...
///
            ...
            //Console.WriteLine($"D = {9.8 * Math.Pow(a, 2) + 5.52 * Math.Cos(Math.Pow(t, 5))}");
...
//
            ...
            //Console.WriteLine($"M = {Math.Cos(2 * y) + 3.6 * Math.Pow(e, x)}");

//
            //Console.WriteLine("Введите значение перемнной - m");
            ...
            //Console.WriteLine($"U = {Math.Exp(y) + 7.355 * Math.Pow(k, 2) + Math.Pow(Math.Sin(x), 2)}");
            ...
            //Console.WriteLine($"K = {7 * Math.Pow(t, 2) + 3 * Math.Sin(Math.Pow(x, 3)) + 9.2}");
            ...
            //Console.WriteLine($"S = {Math.Sqrt(Math.Abs(Math.Cos(4 * Math.Pow(y, 2) + 7.151)))}");
            ...
            //Console.WriteLine($"P = {n * Math.Sqrt(Math.Pow(y, 3) + 1.09 * 9.8)}");
            ...
            //Console.WriteLine($"U = {Math.Exp(k + y) + Math.Tan(x) * Math.Sqrt(y)}");
            ...
            //Console.WriteLine($"P = {Math.Exp(y + 5.5) + 9.1 * Math.Pow(h, 3)}");
            ...
            //Console.WriteLine($"T = {Math.Sin(2 * u) * Math.Log(2 * Math.Pow(y, 2) + Math.Sqrt(x))}");
            ...
            //27
            //Console.WriteLine("Введите значение перемнной - v");
            ...
            //Console.WriteLine($"W = {1.03 * v + Math.Pow(e, 2 * y) + Math.Tan(x)}");
            ...
            //Console.WriteLine("Введите значение перемнной - y");
            //double y = Convert.ToDouble(Console.ReadLine());
            //Console.WriteLine("Введите значение перемнной - h");
            //double h = Convert.ToDouble(Console.ReadLine());

            //Console.WriteLine($"T = {Math.Pow(e, y + h) + Math.Sqrt(Math.Abs(6.4*y))}");
            ...
            //Console.WriteLine("Введите значение перемнной - y");
            //double y = Convert.ToDouble(Console.ReadLine());
            //Console.WriteLine("Введите значение перемнной - r");
            //double r = Convert.ToDouble(Console.ReadLine());

            //Console.WriteLine($"W = {Math.Pow(e, y + r) + 7.2 + Math.Sin(7)}");
